...
public class MainGUI {
   ...
   private static ItemStack createHeadFromTexture(String textureIdOrUrl, String name, String[] lore) {
      ItemStack head = new ItemStack(Material.PLAYER_HEAD);
      SkullMeta meta = (SkullMeta)head.getItemMeta();
      if (meta == null) {
         return head;
      } else {
         String urlStr = textureIdOrUrl;
         if (!textureIdOrUrl.startsWith("http")) {
            urlStr = "https://textures.minecraft.net/texture/" + textureIdOrUrl;
         }
   ...
   static {
      GUI_TITLE = ChatColor.DARK_PURPLE + "RedeemCodes Menu";
   }
}