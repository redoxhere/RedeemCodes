...
public class SelectCodeListGUI {
   ...
   public void open(Player player) {
      ...
      Inventory inv = Bukkit.createInventory((InventoryHolder)null, 54, ChatColor.DARK_PURPLE + "Select: Code List");
   ...
   public void handleClick(InventoryClickEvent event, Player player) {
      if (event.getView().getTitle().contains("Select: Code List")) {
         ...
         if (clickedItem != null && clickedItem.hasItemMeta() && clickedItem.getItemMeta().hasDisplayName()) {
            ...
            if (itemName.equals("Go Back")) {
               ...
               plugin.getDuplicationHandler().startDuplication(player, itemName);
            }
