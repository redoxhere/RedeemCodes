...
public class AdminPanelGUI {
   private static final String pre = "§x§F§B§8§E§2§F§l| §7";
   private static final String GUI_TITLE;

   public static void open(Player player, Main plugin) {
      Inventory inv = Bukkit.createInventory((InventoryHolder)null, 36, GUI_TITLE);
      ...
      inv.setItem(31, HeadManager.getHead("BACK", ChatColor.RED + "Go Back", ChatColor.GRAY + "ʀᴇᴛᴜʀɴ ᴛᴏ ᴍᴀɪɴ ᴍᴇɴᴜ"));
   ...
   static {
      GUI_TITLE = ChatColor.DARK_PURPLE + "Admin Panel";
   }
}
